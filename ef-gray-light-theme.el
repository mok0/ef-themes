;;; ef-gray-light-theme.el --- Legible light theme with white, gray and black colors -*- lexical-binding:t -*-
...
(defconst ef-gray-light-palette-partial
  '((cursor "#464646")
    (bg-main "#fefefe")
    (bg-dim "#ededed")
    (bg-alt "#d7d7d7")
...
(defconst ef-gray-light-palette-mappings-partial
  '((err red-warmer)
...
(defcustom ef-gray-light-palette-overrides nil
  "Overrides for `ef-gray-light-palette'.
...
(defconst ef-gray-light-palette
  (modus-themes-generate-palette
   ef-gray-light-palette-partial
   nil
   nil
   (append ef-gray-light-palette-mappings-partial ef-themes-palette-common)))
...
(modus-themes-theme
 ...
 'light
 'ef-gray-light-palette
 nil
 'ef-gray-light-palette-overrides)

;;; ef-gray-light-theme.el ends here
